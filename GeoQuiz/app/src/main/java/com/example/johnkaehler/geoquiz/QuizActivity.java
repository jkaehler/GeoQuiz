package com.example.johnkaehler.geoquiz;
...
public class QuizActivity extends AppCompatActivity {
    ...
    private Button mTrue, mFalse, mNextButton, mCheatButton;
        ...
        mNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mCurrentIndex == mQuestionBank.length-1){
                    double percentCorrect = (numCorrect/mQuestionBank.length)*100;
                    int intPercentCorrect = (int)Math.round(percentCorrect);
                    Toast.makeText(QuizActivity.this, "Percentage correct: " + intPercentCorrect + "%", Toast.LENGTH_LONG).show();
